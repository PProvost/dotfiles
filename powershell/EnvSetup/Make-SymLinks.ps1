...
$sourcePowershellDirectory = split-path (split-path $scriptLocation)
...
$sourceVimrcPath = join-path $sourceDotfilesDirectory ".vimrc"
...
$sourceVimDirectory = join-path $sourceDotfilesDirectory ".vim"
...
$sourceGitconfigPath = join-path $sourceDotfilesDirectory ".gitconfig"
...
# Make sure the source .gitconfig exists and is a file
$sourceGitignorePath = join-path $sourceDotfilesDirectory ".gitignore"
